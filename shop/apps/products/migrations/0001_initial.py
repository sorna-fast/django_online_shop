    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_name', models.ImageField(upload_to=utils.FileUpload.upload_to, verbose_name='عکس گروه کالا')),
                ...
                ('group_parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='products.poductgroup', verbose_name='والدگروه کالا')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_group', models.ManyToManyField(related_name='features_of_group', to='products.poductgroup', verbose_name='گروه کالا')),
            ],
            options={
                'verbose_name': 'ویژگی',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_group', models.ManyToManyField(related_name='products_of_group', to='products.poductgroup', verbose_name='گروه کالا')),
            ],
            options={
                'verbose_name': 'کالا',
